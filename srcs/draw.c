...
/*   Updated: 2020/10/06 00:50:19 by ashabdan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		get_bg(t_mx *mx)
{
	...
	width = 1280;
	height = 720;
	img_ptr = mlx_xpm_file_to_image(mx->mlx_ptr, mx->bg_img, &width, &height);
	mlx_put_image_to_window(mx->mlx_ptr, mx->win_ptr, img_ptr, 0, 0);
}
